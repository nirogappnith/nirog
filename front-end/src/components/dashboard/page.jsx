...
const Page = () => {
  ...
  return (
    <div className="flex flex-col">
      {showSidebar ? (
        <div className="w-64 h-full left-0 bg-blue-600 fixed z-50">
      ...
      <div className="w-full">
        {(() => {
          switch (currentViewingMode) {
            case "landing":
              return <LandingPage changeMode={changeFromComp} />;
              break;
            case "hospitalSelect":
              return (
                <HospitalSelect
                  changeMode={setCurrentViewingMode}
                  setHospital={hospSelect}
                />
              );
              break;
            case "registration":
              return <RegistrationForm changeMode={setCurrentViewingMode} />;
              break;
            case "report":
              return <MyReports />;
              break;
