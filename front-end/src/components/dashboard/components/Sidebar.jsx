...
const Sidebar = ({ changeViewingMode, onShow }) => {
  ...
  const divClasses =
    "flex items-center cursor-pointer py-1 gap-2 rounded-md px-2";

  return (
    <div className="text-sm flex-col h-full space-y-3 px-3 font-inter">
      {" "}
      {/* Reduce the width by 30% */}
      ...
      <div
        className={`flex flex-col space-y-3 text-lg w-full mt-10 text-white `}
      >
        <div
          className={`${divClasses} ${currentModeLocal == "landing" && `bg-blue-500`}`}
        >
        ...
        <div
          className={`${divClasses} ${currentModeLocal == "report" && `bg-blue-500`}`}
        >
        ...
        <div
          className={`${divClasses} ${currentModeLocal == "prescription" && `bg-blue-500`}`}
        >
        ...
        <div
          className={`${divClasses} ${currentModeLocal == "doxaab" && `bg-blue-500`}`}
        >
          <p
            className={`m-0 `}
            onClick={() => {
